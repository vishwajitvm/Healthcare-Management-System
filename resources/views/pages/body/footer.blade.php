...
<script
    src="{{asset('backend/backend/backend/developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js')}}">
</script>
<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=true"></script>
<script type="text/javascript" src="{{asset('backend/files/assets/pages/google-maps/gmaps.js')}}"></script>
...
<script type="text/javascript" src="{{asset('backend/files/assets/pages/dashboard/crm-dashboard.min.js')}}"></script>
